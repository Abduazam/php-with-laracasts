            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="/register" method="POST">
                    <div>
                        ...
                        <div class="mt-2">
                            <input id="name" name="name" type="text" autocomplete="name" value="<?= old('name') ?>" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                        <?php if (isset($errors['name'])) : ?>
                            <p class="text-red-500 mt-2 text-xs"><?= $errors['name'] ?></p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div>
                        ...
                        <?php if (isset($errors['email'])) : ?>
                            <p class="text-red-500 mt-2 text-xs"><?= $errors['email'] ?></p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div>
                        ...
                        <?php if (isset($errors['password'])) : ?>
                            <p class="text-red-500 mt-2 text-xs"><?= $errors['password'] ?></p>
                        <?php endif; ?>
                    </div>
